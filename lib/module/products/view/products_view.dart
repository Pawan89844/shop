...
class ProductsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<HomeViewModel>(builder: (context, viewModel, __) {
      return Scaffold(
        appBar: AppBar(
            forceMaterialTransparency: true,
            actions: actions,
            title:
                AppText(AppString.productsPage.toUpperCase(), fontSize: 18.0)),
        body: GridView.builder(
          ...
          itemCount: viewModel.appProducts?.message.length,
          shrinkWrap: true,
