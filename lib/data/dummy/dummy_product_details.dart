...
class DummyProductDetails {
  static final List<ProductDetailsModel> details = <ProductDetailsModel>[
    ProductDetailsModel(
        id: 0,
        productImage: [
          'https://m.media-amazon.com/images/I/61hI3GkYHNL._SX679_.jpg'
        ],
        productName:
        ...
        productDescription: AppString.dummyDescription,
        productPrice: 50.00),
    ProductDetailsModel(
        id: 1,
        productImage: [
          'https://m.media-amazon.com/images/I/81a+-Kop5sL._SY879_.jpg'
        ],
        productName:
    ...
    ProductDetailsModel(
        id: 2,
        productImage: [
          'https://m.media-amazon.com/images/I/81csgfZcMmL._SY879_.jpg'
        ],
    ...
    ProductDetailsModel(
        id: 3,
        productImage: [
          'https://m.media-amazon.com/images/I/71kE75JMKjL._SY879_.jpg'
        ],
        productName:
    ...
    ProductDetailsModel(
        id: 4,
        productImage: [
          'https://m.media-amazon.com/images/I/81yhiXK3+kL._SY879_.jpg'
        ],
